...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
      ...
      <table align="left" border="0" cellpadding="2" cellspacing="0" style="width: 100%">
        <tr>
          <th align="left" class="style10">
            <font size="+1">Vender Bank Account Information Creation&#160; </font>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/VenderList.aspx">Vender List</asp:HyperLink>&#160;<asp:Label
              ID="lbMessage" runat="server" ForeColor="Red" OnLoad="lbMessage_Load"></asp:Label>
          </th>
        </tr>
        <tr>
          <td>
            <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td width="30%" colspan="3">
                  <asp:DropDownList ID="ddlPaymentType" runat="server" Enabled="False" OnPreRender="ddlPaymentType_PreRender">
              ...
              <tr align="center">
                <td>
                  <asp:LinkButton ID="InsertButton" runat="server" CausesValidation="True" CommandName="Insert"
                    Text="Create" />&#160;&nbsp;<asp:LinkButton ID="InsertCancelButton" runat="server"
                      CausesValidation="False" CommandName="Cancel" Text="Cancel" />&#160; &nbsp;<asp:LinkButton
                        ID="LinkButton1" runat="server" CausesValidation="False" Text="Next" OnClick="LinkButton1_Click" />
  ...
  <asp:FormView ID="FormView2" runat="server" DataKeyNames="id" SkinID="FormView" DataSourceID="EntityDataSource1"
    DefaultMode="Insert" Width="100%">
    <InsertItemTemplate>
      <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"><ContentTemplate>--%>
      <table align="left" border="0" cellpadding="2" cellspacing="0" style="width: 100%">
        <tr>
          <th align="left" class="style10">
            <font size="+1">Special Bank Account Information</font><asp:HyperLink ID="HyperLink1"
              runat="server" NavigateUrl="~/Admin/VenderList.aspx">Vender List</asp:HyperLink>&#160;<asp:Label
                ID="lbMessage" runat="server" ForeColor="Red" OnLoad="lbMessage_Load"></asp:Label>
          </th>
        </tr>
        <tr>
            ...
            <table align="center" border="1" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                ...
                <td width="30%">
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="tbWuDestination"
  ...
  <asp:Label ID="lblWest" runat="server" Text="西聯" Visible="false"></asp:Label>
